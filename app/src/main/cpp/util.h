...
#ifndef CARDBOARD_ANDROID_SRC_MAIN_JNI_UTIL_H_
#define CARDBOARD_ANDROID_SRC_MAIN_JNI_UTIL_H_
...
#define LOG_TAG "MazeCardboardApp"
#define LOGW(...) __android_log_print(ANDROID_LOG_WARN, LOG_TAG, __VA_ARGS__)
#define LOGD(...) __android_log_print(ANDROID_LOG_DEBUG, LOG_TAG, __VA_ARGS__)
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, __VA_ARGS__)
#define MAZECARDBOARD_CHECK(condition)                                    \
  if (!(condition)) {                                                      \
    LOGE("*** CHECK FAILED at %s:%d: %s", __FILE__, __LINE__, #condition); \
    abort();                                                               \
  }

namespace ndk_maze_cardboard {
...
#endif  // CARDBOARD_ANDROID_SRC_MAIN_JNI_UTIL_H_
